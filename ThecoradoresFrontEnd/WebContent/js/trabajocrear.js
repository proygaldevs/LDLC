	 ...
	 try {
	  		...
	  		$.ajax({
	  			...
	  			data : {
	  				...
	  				action : "decoradores_add_trabajo",
	  				pass : decorador.pass,
	  				trabajo: trabajoJson
	  			},
	  			// url: 'http://81.47.163.149:8080/Solvida_JSON_R/getNews',
	  			...
	  			success : function(data) {
	  				...
	  				if (isError(data)) {
  						...
  						trabajo.id=data;
  						localStorage.setItem('trabajoformodificar', JSON.stringify(trabajo));
  						window.location.href=urlbaseForThecoradores+ "trabajomodificar.html";
