...
public class S3Sample {
    ...
    public int  deleteFile( String path, String fichero) throws Exception {
		...
		String cadenaFichero= new Config().bucket_protocol+":/"+"/"+new Config().bucket_name+"."+new Config().bucket_region+"/"+fichero;
		UrlsManage urlM = new UrlsManage(cadenaFichero, new Config().bucket_name);
        urlM.deleteFileBBDD();
    ...
    public  ArrayList<String> listFilesInFolder( String prefix) throws Exception {
         ...
         String cadenaPrefix= new Config().bucket_name+"."+new Config().bucket_region+"/"+prefix;
    ...
    public String insertarFicheroS3(InputStream content,String path,String key) throws Exception{
     ...
     // String urlReturn = s3.getUrl(bucketName, key).toString();
        String urlReturn = new Config().bucket_protocol+":/"+"/"+new Config().bucket_name+"."+new Config().bucket_region+"/"+key;
    ...
    public String insertarFicheroS3Extensionjpg(BufferedImage img,String path,String key) throws Exception{
    ...
    public String insertarFicheroS3Extensionpng(BufferedImage img,String path,String key) throws Exception{
