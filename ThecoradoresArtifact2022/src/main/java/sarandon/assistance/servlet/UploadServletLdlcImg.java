...
public class UploadServletLdlcImg extends HttpServlet {
	private final static Logger log = Logger.getLogger(UploadServletLdlcImg.class);
...
public void createRouteMoodboards() {
	String relativeWebPath = "/moodboards/";
...
public void doPost(HttpServletRequest req, 
	...
	log.info("class UploadServletLdlcImg");
	InputStream in = null;
    FileOutputStream fos = null;
    try {
    	createRouteMoodboards();
        ...
        String nombre= "ideas-decoracion-"+String.valueOf(System.currentTimeMillis()) + ".png";
 	   ...
 	   String rutaImagen= s3.insertarFicheroS3(file,getServletContext().getRealPath("/credentials"),"ldlc/imagenes/"+nombre);
 	   file.delete();
