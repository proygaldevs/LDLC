 ...
 */
public class GetColorsModBoard extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private final static Logger log = Logger.getLogger(GetColorsModBoard.class);
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetColorsModBoard() {
        super();
...
//		String jsonText = Utils.readFile("/Users/raul/Desktop/Hoteles/apache-tomcat-6.0.33/webapps/hs5/docs/promociones.json");
		...
		try{
			jsonText=hht.getColoresModBoardJson(paso4);
			log.info(jsonText);
		}catch(Exception e){
