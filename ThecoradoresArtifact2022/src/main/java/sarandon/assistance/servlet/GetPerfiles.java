...
public class GetPerfiles extends HttpServlet {
	...
	private final static Logger log = Logger.getLogger(GetPerfiles.class);
    /**
...
//		String jsonText = Utils.readFile("/Users/raul/Desktop/Hoteles/apache-tomcat-6.0.33/webapps/hs5/docs/promociones.json");
		...
		String subcarpeta = request.getParameter("subcarpeta");
		...
		try{
			...
			jsonText=hht.getPerfiles(carpeta, subcarpeta, absoluteDiskPath);
			log.info(jsonText);
		}catch(Exception e){
