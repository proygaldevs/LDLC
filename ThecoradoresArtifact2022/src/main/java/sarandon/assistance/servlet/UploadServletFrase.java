...
public class UploadServletFrase extends HttpServlet {
	private final static Logger log = Logger.getLogger(UploadServletFrase.class);
...
File file = File.createTempFile(nombre,".png");
 	   ...
 	   String rutaImagen= s3.insertarFicheroS3(file,getServletContext().getRealPath("/credentials"),rutaquenecesito+nombre);
 	   file.delete();
