...
public class UploadServlet2 extends HttpServlet {
	private final static Logger log = Logger.getLogger(UploadServlet2.class);
...
public void doPost(HttpServletRequest req, 
    ...
    try {
        ...
        String nombre= "moodboard-"+String.valueOf(System.currentTimeMillis()) + ".png";
        ...
        String rutaImagen= s3.insertarFicheroS3(file,getServletContext().getRealPath("/credentials"),"moodboards/"+nombre);
 	   file.delete();
