...
var imgRoute=getParameterByName('vr');
...
// Create view.
var limiter = Marzipano.RectilinearView.limit.traditional(512, 110*Math.PI/180);
...
function createLayer(stage, view, geometry, eye, rect) {
    ...
    var source = Marzipano.ImageUrlSource.fromString(
    		urlPrefix + idProyect+ "/tiles/"  +imgRoute+  "/{z}/{f}/{y}/{x}.jpg",
      { cubeMapPreviewUrl: urlPrefix + idProyect+ "/tiles/" + imgRoute+ "/preview.jpg" });
  if(encarpeta==true){
	   urlPrefix = "tiles";
	   source = Marzipano.ImageUrlSource.fromString(
	    		urlPrefix + "/" +imgRoute+ "/{z}/{f}/{y}/{x}.jpg",
	      { cubeMapPreviewUrl: urlPrefix + "/" + imgRoute+ "/preview.jpg" });
  }
  console.log("source", urlPrefix + idProyect+ "/tiles/" + imgRoute+ "/preview.jpg" );
