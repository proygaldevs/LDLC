...
function ldlc(){
	...
	html += '<div style="list-style:none;padding-left:15px;padding-right:15px" class="filtros">';
		...
		html += '<div class="nldlc col-xs-12 letra-m letra-negrita" style="margin-top:50px">'+lista.nombreLdlc+'</div>';
...
function resumenItems(){ 
	...
	$.each(arrayItems, function(i, item) {
		...
		if(total>0){
			...
			cadena+='		<a class="col-xs-12 col-xs-offset-0 col-sm-12 buttonstandard_invertido botonComprar2 " style="widht:auto;" target="_blank" href="'+tiendaEnlace+'">comprar</a>'; 
			cadena+='</div>';
		}
